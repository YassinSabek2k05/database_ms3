...
exports.HR_approval_unpaid = async (request_ID , HR_ID) => {
    // Implementation for approving/rejecting unpaid leaves
};
//4.
exports.HR_approval_comp = async (request_ID , HR_ID) => {
    // Implementation for approving/rejecting compensatory leaves
};
...
exports.getAnAccRequests = async (HR_ID) => {
    ...
    SELECT e.employee_id, e.first_name,e.last_name,e.dept_name, eal.status
    FROM Leave l
